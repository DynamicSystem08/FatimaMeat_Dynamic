        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Grid container>
              ...
              <Grid item lg={1.4} md={1.4} sm={1.8}  xs={10} onClick={() => navigate("/ourMeat")} style={{ cursor: "pointer" }} className="text_Header">
                OUR MEAT
              </Grid>

              <Grid item lg={2} md={2} sm={1.5} xs={10} onClick={() => navigate("/recipes")} style={{ cursor: "pointer" }} className="text_Header">
                RECIPES
              </Grid>
              ...
              <Grid item lg={1.6} md={1.8} xs={10} onClick={() => navigate("/fatimaFood")} style={{ cursor: "pointer" }} className="text_Header" >
                FATIMA FOOD
              </Grid>
